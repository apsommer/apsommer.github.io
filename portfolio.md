...
I am [Drew Sommer](https://www.linkedin.com/in/apsommer/) - an Android developer with a previous career in mechanical engineering. After specializing in machine dynamics for nearly a decade my passion for software engineering guided a career change. I believe in the democratization of the internet and creating mobile apps that are accessible to everyone. My latest product BarAudio provides audible realtime alerts for the financial markets. My recent project with Electrify America is a green initiative that simplifies the charging of electric vehicles. I love collaborating on teams and have experience mentoring others.
